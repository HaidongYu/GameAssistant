...
def yolo_detect(pathIn='/home/haidong/Desktop/02018.jpg',
                ...
                weights_path='/home/haidong/darknet/yolov3-tiny_80000.weights',
                confidence_thre=0.5,
                nms_thre=0.3,
                jpg_quality=80):
 '''
...
def yolo_detect(pathOut='/home/haidong/Desktop/test.jpg',
                # pathOut=None,
                label_path='/home/haidong/darknet/data/coco.names',
                config_path='/home/haidong/darknet/cfg/yolov3-tiny.cfg',
                weights_path='/home/haidong/darknet/yolov3-tiny_10000.weights',
                confidence_thre=0.5,
                nms_thre=0.3,
                jpg_quality=80):
 ...
 '''
    ...
    if pathOut is None:
       cv2.imwrite('with_box_' + base_path, img, [int(cv2.IMWRITE_JPEG_QUALITY), jpg_quality])
        ...
        #img = Image.open('/home/haidong/Desktop/test.jpg')
        #img.show()
        ''''
        cv2.imwrite(img, [int(cv2.IMWRITE_JPEG_QUALITY), jpg_quality])
        plt.imshow(img)
        plt.show()
        '''
yolo_detect()